...
@wip
Escenario: US-17.3 El paciente ya está registrado con un id
    Dado el paciente ya está registrado con un id "id"
...
@wip
Escenario: US-17.5 El paciente se intenta registrar sin indicar su email
