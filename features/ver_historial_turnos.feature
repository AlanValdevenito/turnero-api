...
Característica: Ver historial de turnos
  ...
  Escenario: US-6.2 Ver historial de turnos con 1 turno ausente
    ...
    Cuando quiero ver mi historial de turnos
    Entonces puedo ver mi turno con el médico "Juan Perez" de la especialidad "Cardiologia" con estado "Ausente"
  ...
  Escenario: US-6.3 Ver historial de turnos con 1 turno al que el paciente asistio
    ...
    Y asisti al turno
    Cuando quiero ver mi historial de turnos
    Entonces puedo ver mi turno con el médico "Juan Perez" de la especialidad "Cardiologia" con estado "Asistido"
  ...
  Escenario: US-6.4 Ver historial de turnos con 1 turno cancelado
    ...
    Y cancele el turno
    Cuando quiero ver mi historial de turnos
    Entonces puedo ver mi turno con el médico "Juan Perez" de la especialidad "Cardiologia" con estado "Cancelado"
